...
public class CurrentCourseActivity extends ListActivity {
			...
			case DIALOG_ADD_COURSE:
				...
				btnNewCreate.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						alertDialog.dismiss();
						Toast.makeText(CurrentCourseActivity.this, msg, Toast.LENGTH_SHORT).show();
					}
				});
		}
	}
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		if (item.getItemId() == R.id.menu_upcoming) {
			controller.handleContextMenuItemClicked(this, item, getListView(), datasource, Course.STATUS.UPCOMING);
		} else if (item.getItemId() == R.id.menu_taken) {
			controller.handleContextMenuItemClicked(this, item, getListView(), datasource, Course.STATUS.TAKEN);
		} 
	...
	protected void onResume() {
		...
		adapter = new CourseAdapter(datasource.getCourses(Course.STATUS.CURRENT), this, datasource);
